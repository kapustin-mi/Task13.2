...
public class GameFrame extends JFrame {
    ...
    private boolean shouldContinueGame = true;

    private final int DEFAULT_CELL_SIZE = 140;
    ...
    public GameFrame() {
        ...
        this.setBounds(672, 250, DEFAULT_CELL_SIZE, DEFAULT_CELL_SIZE);
        this.pack();
        ...
        gameTable.setDefaultRenderer(Object.class, new DefaultTableCellRenderer() {
            final class DrawComponent extends Component {
                ...
                public void paint(Graphics gr) {
                    ...
                    int size = DEFAULT_CELL_SIZE - 5;
                    paintTile(row, column, g2d, size, arr);
                }
            }
    ...
    private void paintTile(int row, int column, Graphics2D g2d, int tileSize, int[][] arr) {
        Color color = colorMap.get(arr[row][column]);

        int bound = tileSize / 27;
        ...
        if (tileValue != 0) {
            ...
            int x = (int) ((tileSize - rect.getWidth()) / 2);
            int y = (int) ((tileSize - rect.getHeight()) / 2);
